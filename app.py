...
#delete store
@app.route('/stores/delete/<int:store_id>',methods=['DELETE'])  
...
#update store
@app.route('/stores/update/<int:store_id>',methods=['PUT'])  
def update_store(store_id):
    updated_store_data=dict(request.get_json())
    try:
        stores[store_id]=updated_store_data
    except:
        return{'message':'Store not Found'},404
